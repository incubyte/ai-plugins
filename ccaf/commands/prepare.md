...
The curriculum is the existing blueprint (5 domains, 30 task statements, 6 scenarios). Teaching
stays strictly inside the blueprint's in-scope list.
...
1. Read the blueprint as the curriculum.
...
5. Track what's solid vs. shaky; show the map on request; recommend `/ccaf:mock-exam` when a
   domain looks solid.
