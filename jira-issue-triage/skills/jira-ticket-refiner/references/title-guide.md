...
The title is the highest-leverage piece of text on a ticket. It shows up in:

- Board cards and list views.
- Jira search results.
- Slack unfurls when the ticket URL is pasted.
- Email notifications and digest summaries.
- Sprint planning exports and burndown charts.
- The Jira sidebar of any ticket that links to this one.

A good title lets a teammate decide whether to open the ticket without clicking through. A vague title forces them to open it just to find out, every time.
...
3. **Add the differentiator.** If there are ten SSO tickets in the project, the title for this one says what makes it specific.
4. **Stay under 80 characters.** Jira truncates long summaries on board and list views. Aim for 60 to 75 characters in the rewritten title; treat 80 as the hard ceiling.
...
Use this base pattern. Add modifiers when the ticket warrants them.
